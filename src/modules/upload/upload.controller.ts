...
import { UploadSignatureResultDto, UploadUrlDto } from '../../common/dto/entities.dto';
...
export class UploadController {
  ...
  signature(@CurrentUser('userId') userId: string, @Body() dto: SignatureDto) {
    return this.uploadService.createSignature(userId, dto.scene as UploadScene, dto.ext);
  }
